    ...
    for(const addressBookData of addressBookList){
        innerHtml = `${innerHtml}
         <tr>
            ...
            <td>
            <img id="${addressBookData._name}" onclick="remove(this)" alt="delete" src="Images/delete-black-18dp.svg">
            <img name="${addressBookData._name}" onclick="update(this)" alt="edit" src="Images/create-black-18dp.svg">
            </td>
         </tr>
        `;
        }
